% 图表统一管理文件（根据 1.md 整理）
% TODO: 将 \includegraphics 中的文件名替换为实际图片路径（例如导出的 PDF/PNG）

\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig1}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig2}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig3}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig4}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig5}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig6}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig7}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig8}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\textwidth]{media/fig9}
